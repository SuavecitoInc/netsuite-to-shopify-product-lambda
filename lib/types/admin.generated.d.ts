...
export type ProductCreateMutation = {
  productCreate?: AdminTypes.Maybe<{
    product?: AdminTypes.Maybe<
      Pick<AdminTypes.Product, 'id' | 'legacyResourceId'>
    >;
...
export type ProductVariantsBulkCreateMutation = {
  productVariantsBulkCreate?: AdminTypes.Maybe<{
    userErrors: Array<
      Pick<AdminTypes.ProductVariantsBulkCreateUserError, 'field' | 'message'>
    >;
    product?: AdminTypes.Maybe<
      Pick<AdminTypes.Product, 'id'> & {
        options: Array<
          Pick<
            AdminTypes.ProductOption,
            'id' | 'name' | 'values' | 'position'
          > & {
            optionValues: Array<
              Pick<AdminTypes.ProductOptionValue, 'id' | 'name' | 'hasVariants'>
            >;
          }
        >;
      }
...
export type ProductVariantsBulkUpdateMutation = {
  productVariantsBulkUpdate?: AdminTypes.Maybe<{
    ...
    productVariants?: AdminTypes.Maybe<
      Array<
        Pick<AdminTypes.ProductVariant, 'id'> & {
          metafields: {
            edges: Array<{
              node: Pick<AdminTypes.Metafield, 'namespace' | 'key' | 'value'>;
            }>;
          };
        }
      >
    >;
    userErrors: Array<
      Pick<AdminTypes.ProductVariantsBulkUpdateUserError, 'field' | 'message'>
    >;
  }>;
};
...
export type ProductByHandleQuery = {
  productByHandle?: AdminTypes.Maybe<
    Pick<
      AdminTypes.Product,
      | 'id'
      | 'handle'
      ...
      | 'tags'
    > & {
      options: Array<Pick<AdminTypes.ProductOption, 'name' | 'values'>>;
      variants: {
        edges: Array<{
          node: Pick<
          ...
          > & {
            inventoryItem: {
              measurement: {
                weight?: AdminTypes.Maybe<
                  Pick<AdminTypes.Weight, 'unit' | 'value'>
                >;
              };
            };
          };
...
interface GeneratedMutationTypes {
  ...
  '#graphql\n  mutation ProductVariantsBulkCreate($productId: ID!, $variants: [ProductVariantsBulkInput!]!) {\n    productVariantsBulkCreate(productId: $productId, strategy: REMOVE_STANDALONE_VARIANT, variants: $variants) {\n      userErrors {\n        field\n        message\n      }\n      product {\n        id\n        options {\n          id\n          name\n          values\n          position\n          optionValues {\n            id\n            name\n            hasVariants\n          }\n        }\n      }\n      productVariants {\n        id\n        title\n        selectedOptions {\n          name\n          value\n        }\n      }\n    }\n  }\n': {
    return: ProductVariantsBulkCreateMutation;
    variables: ProductVariantsBulkCreateMutationVariables;
  };
  '#graphql\n  mutation productVariantsBulkUpdate($productId: ID!, $variants: [ProductVariantsBulkInput!]!) {\n    productVariantsBulkUpdate(productId: $productId, variants: $variants) {\n      product {\n        id\n      }\n      productVariants {\n        id\n        metafields(first: 2) {\n          edges {\n            node {\n              namespace\n              key\n              value\n            }\n          }\n        }\n      }\n      userErrors {\n        field\n        message\n      }\n    }\n  }\n': {
    return: ProductVariantsBulkUpdateMutation;
